                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400"><?= $row['email_id']?></h6>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600"></h6>
                                 ...
                                 <ul class="social-link list-unstyled m-t-40 m-b-10">
                                    <li><a href="updatepro.php" data-toggle="tooltip" data-placement="bottom" title="" style="width: 160px;" data-original-title="facebook" data-abc="true" class="btn btn-secondary">Update Profile</a></li>
