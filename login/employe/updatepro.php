                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 user-profile">
                            <div class="card-block text-center text-white">
                                  <div class="m-b-25"> <img height="150px" src="../../Controller/admin/<?= $row['pro_pic']?>" class="img-radius" alt="User-Profile-Image"> </div>
                               <h6 class="f-w-600"><?= $row['name']?></h6>
                                <p>Employee id :  <?= $row['e_id']?></p> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                             <center>
                           <form style="border:2px solid lightblue; border-radius : 10px ;padding:10px;" enctype="multipart/form-data" action="../../Controller/employee/update.php" method="post">
                                <label for="" class="label-control"> Change Profile Picture</label>    
                                <input required type="file" name="propic" class="form-control"><br>
                                <input type="submit" name="changepropicemp" value="Change" class="btn ">
                            </form>
                            </center>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <div class="row">
                                <form method="POST" action="../../Controller/employee/update.php">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Email-id</p>
                                        <h6 class="text-muted f-w-400"><input type="text" name="email" class="form-control" value="<?= $row['email_id']?>"></h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Phone</p>
                                        <h6 class="text-muted f-w-400"><input type="text" name="ph" maxlength="10" class="form-control" value="<?= $row['phone']?>"></h6>
                                    </div>
                                </div>
                                <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Address</h6>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">House</p>
                                ...
                                <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600"></h6>
                                 ...
                                 <ul class="social-link list-unstyled m-t-40 m-b-10">
                                    <li><input type="submit" name="eprou" value="Update" data-toggle="tooltip" data-placement="bottom" title="" style="width: 160px;font-size:20px;color:#3287b2;" onMouseOver="this.style.color='black'"
 ...
 data-toggle="modal" data-toggle="tooltip" data-placement="bottom" title="" style="width: 200px;" data-original-title="facebook" data-abc="true" class="btn btn-secondary">Change Password</a></li>
				...
				<div class="modal-dialog" role="document">
					...
					<div class="modal-body">
						<form action="../../Controller/employee/update.php" method="POST">
