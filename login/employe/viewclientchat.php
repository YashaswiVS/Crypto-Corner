    ...
    <div id="wrapper">
        ...
        <br>
            <div class="">
                ...
                <a href="msgfromclient.php" class="btn btn-primary">Go Back</a>
                                                ...
                                                <div id="demo-chat-body" class="collapse in">
                                                    <div class="nano has-scrollbar" style="height:380px">
                                                        <div class="nano-content pad-all" tabindex="0" style="right: -17px;">
                                                            ...
                                                            $bstmt = $admin -> ret("SELECT * FROM `employee` WHERE `e_id` = '$eid' ORDER BY `name` ASC");
                                                            $brow = $bstmt -> fetch(PDO::FETCH_ASSOC);
                                                        
                                                                $stmt = $admin -> ret("SELECT * FROM `emp_msg_to_client` WHERE `c_id` = '$cid' AND `e_id` = '$eid'");
                                                        ...
                                                        ?>
                                                            ...
                                                            ?>
                                                                <li class="mar-btm">
                                                                    <div class="media-left">
                                                                        <img src="../../Controller/admin/<?= $arow['profile_pic']?>" class="img-circle img-sm" alt="Profile Picture">
                                                            ...
                                                            <?php } ?>
                                                            <?php
                                                            if($row['from'] == "employee"){ 
                                                            ?>
                                                                <li class="mar-btm">
                                                                    <div class="media-right">
                                                                        <img src="../../Controller/admin/<?= $brow['pro_pic']?>" class="img-circle img-sm" alt="Profile Picture">
                                                                    </div>
                                                    ...
                                                    <div class="panel-footer">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-9">
                                                            <input type="hidden" required=" " name="cid" value="<?= $cid?>">
                                                                <input type="text" required=" " name="msg" placeholder="Enter your text" class="form-control chat-input">
                                                            </div>
                                                            <div class="col-xs-3">
                                                                <button class="btn btn-primary btn-block" type="submit" name="fromemptoclient">Send</button>
                                                            </div>
