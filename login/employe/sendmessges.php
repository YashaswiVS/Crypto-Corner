				...
				<div class="container-fluid">
					<h3 class="page-title">Send Message</h3><hr>
						...
						<div class="panel container" style="padding:10px;">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                    <!-- <div class="" style="padding-right:150px;padding-left:150px;"> -->
                                        <h2 class="text-center">To Admin</h2><hr>
                                        <form action="../../Controller/employee/add.php" method="post">
                                            <div class="form-group">
                                                  <select  disabled class="form-control" name="emp_id" id="" required> 
                                            ...
                                            <div class="form-group">
                                                <input type="submit" class="form-control btn btn-primary" name="msgforadminfromemp" value="Send">
                                            </div>
                                        </form>
                                    </div>
                                  <div class="col-lg-6">
