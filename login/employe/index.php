					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-3">
									<a href="vcl.php">	<div class="metric">
										...
										<p>
											...
											$stmt = $admin -> ret("SELECT COUNT(*) FROM `assignclienttoemp` WHERE `emp_id` = '$emp_id' ");
								...
								<div class="col-md-3">
									<a href="viewcfiles.php">	<div class="metric">
										<span class="icon"><i class="fa fa-files-o"></i></span>
										<p>
											<span class="number"><?php

											$stmt = $admin -> ret("SELECT COUNT(*) FROM `auditedfiles` WHERE `emp_id` = '$chemp'");
											$row = $stmt -> fetch(PDO::FETCH_ASSOC);
											echo implode($row);
							...
							<div class="panel">
								...
								<div class="panel-body no-padding">
									<table class="table table-striped">
										...
										<tbody>
											<?php
												$stmt = $admin -> ret("SELECT * FROM `auditedfiles` WHERE `emp_id` = '$emp_id' ORDER BY `a_id` DESC LIMIT 10");
												$i=0;
						...
						<div class="col-md-6">
							...
							<div class="panel">
										...
										<input type="button" value="ADD TO-DO-LIST" data-target="#editMezalta" class="btn btn-info" data-toggle="modal" style="color:black;">&nbsp;&nbsp;
											...
											<div class="modal-dialog" role="document">
												...
												<div class="modal-body">
													<form action="../../Controller/employee/add.php" method="POST">
								...
								<div class="panel-body">
									...
									<?php
												$stmt = $admin -> ret("SELECT * FROM `emp_to_do_list` WHERE `emp_id` = '$emp_id' ORDER BY `t_id` DESC");
												$i=0;
												while($row = $stmt-> fetch(PDO::FETCH_ASSOC))
												{ 
													$i++;
										...
										<li>
											...
											<a href="../../Controller/employee/dlt.php?dlttodo=<?= $row['t_id']?>"><img height="30px" src="./../../images/delete.png" alt=""></a>
										</li>
