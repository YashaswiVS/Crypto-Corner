    ...
    <div id="wrapper">
        ...
        <br>
            <div class="">
                ...
                <a href="msgfromemp.php" class="btn btn-primary">Go Back</a>
                                                ...
                                                <div id="demo-chat-body" class="collapse in">
                                                    <div class="nano has-scrollbar" style="height:380px">
                                                        <div class="nano-content pad-all" tabindex="0" style="right: -17px;">
                                                            ...
                                                            $bstmt = $admin -> ret("SELECT * FROM `employee` WHERE `e_id` = '$emp' ORDER BY `name` ASC");
                                                            $brow = $bstmt -> fetch(PDO::FETCH_ASSOC);
                                                        
                                                                $stmt = $admin -> ret("SELECT * FROM `emp_msg_to_client` WHERE `c_id` = '$cid' AND `e_id` = '$emp'");
                                                    ...
                                                    <div class="panel-footer">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-9">
                                                            <input type="hidden" required=" " name="empid" value="<?= $emp?>">
                                                                <input type="text" required=" " name="msg" placeholder="Enter your text" class="form-control chat-input">
                                                            </div>
                                                            <div class="col-xs-3">
                                                                <button class="btn btn-primary btn-block" type="submit" name="fromclienttoemp">Send</button>
                                                            </div>
