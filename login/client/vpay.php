		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="btn btn-primary" href="viewadminchat.php">Send Message </a>    
					<div class="panel container" style="padding:10px;">
                        ...
                        <tbody>
                            ...
                            <?php
                             $cid =$_SESSION['uid'];
                            $stmt = $admin -> ret("SELECT * FROM `payment` WHERE cl_id = '$cid' ");
                            $i=0;
                        ...
                        <tr>
                            ...
                            <td><a href="../../Controller/client/dlt.php?dltpayemt=<?= $row['pay_id']?>" class="btn btn-danger">Delete</a></td>
                        </tr>
