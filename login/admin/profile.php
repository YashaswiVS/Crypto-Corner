                      ...
                      <div class="row container d-flex justify-content-center">
                          <div class="col-xl-6 col-md-12">
                              <div class="card user-card-full">
                                  ...
                                  { 
                                  ?>
                                      <img height="150px" src="../../Controller/<?= $row['profile_pic']?>" class="img-radius" alt="User-Profile-Image"> 
                                  <?php 
                                  }
                                  else
                                  {
                          ...
                          <form style="border:2px solid lightblue; border-radius : 10px ;padding:10px;" enctype="multipart/form-data" action="../../Controller/profile.php" method="post">
                            ...
                            <div class="card-block">
                                ...
                                <form method="POST" action="../../Controller/profile.php">
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400"><input value="<?= $row['name']?>" type="text" name="name" maxlength="10" class="form-control" ></h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Email-id</p>
                                        <h6 class="text-muted f-w-400"><input value="<?= $row['email']?>" type="text" name="email" class="form-control"></h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Phone</p>
                                        <h6 class="text-muted f-w-400"><input value="<?= $row['phone_number']?>" type="text" name="ph" maxlength="10" class="form-control" ></h6>
                                    </div>
                                </div>
                                 
                                 <ul class="social-link list-unstyled m-t-40 m-b-10">
                                    <li><input type="submit" name="adminupdate" value="Update" data-toggle="tooltip" data-placement="bottom" title="" style="width: 160px;font-size:20px;color:#3287b2;" onMouseOver="this.style.color='black'"
                        ...
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <form method="POST" action="../../Controller/profile.php">
                                   <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Name</p>
                                        <h6 class="text-muted f-w-400"><input type="text" name="name" maxlength="10" class="form-control" ></h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Email-id</p>
                                        <h6 class="text-muted f-w-400"><input type="text" name="email" class="form-control"></h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Phone</p>
                                        <h6 class="text-muted f-w-400"><input type="text" name="ph" maxlength="10" class="form-control" ></h6>
                                    </div>
                                 ...
                                 <ul class="social-link list-unstyled m-t-40 m-b-10">
                                    ...
                                    <li><input type="submit" name="saveprofileadmin" value="Save Profile" data-toggle="tooltip" data-placement="bottom" title="" style="width: 160px;font-size:20px;color:#3287b2;" onMouseOver="this.style.color='black'"
   onMouseOut="this.style.color='#3287b2'" data-original-title="facebook" data-abc="true" class="btn btn-secondary"></li>
                                      <li><a href="#"data-target="#editMezalta"
 data-toggle="modal" data-toggle="tooltip" data-placement="bottom" title="" style="width: 200px;" data-original-title="facebook" data-abc="true" class="btn btn-secondary">Change Password</a></li>
                                 <li><a href="profile.php" data-toggle="tooltip" data-placement="bottom" title="" style="width: 160px;" data-original-title="facebook" data-abc="true" class="btn btn-secondary">Back</a></li>
