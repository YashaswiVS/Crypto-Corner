		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Message</h3><hr>
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
					<div class="panel container" style="padding:10px;">
                          ...
                          <table class="table">
                            ...
                            <tbody id="catres">
                                ...
                                $stmt = $admin -> ret("SELECT * FROM `employee` ORDER BY `name` ASC  ");
                                ...
                                <tr>
                                    ...
                                    <td><?= $row['name']?></td>
                                    <td>
                                        <a href="viewempmsg.php?emp=<?= $row['e_id']?>" class="btn btn-success"><i class="fa fa-envelope"></i></a>
                                   </td>
                                </tr>
