				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-3">
									<a href="vcl.php">	<div class="metric">
										<span class="icon"><i class="fa fa-user"></i></span>
										<p>
											<span class="number"><?php
											$stmt = $admin -> ret("SELECT COUNT(*) FROM `clients`");
								...
								<div class="col-md-3">
								<a href="vemp.php">		<div class="metric">
								...
								<div class="col-md-3">
									<a href="verifyaf.php">	<div class="metric">
										<span class="icon"><i class="fa fa-files-o"></i></span>
										<p>
											<span class="number"><?php
											$stmt = $admin -> ret("SELECT COUNT(*) FROM `auditedfiles`");
											$row = $stmt -> fetch(PDO::FETCH_ASSOC);
											echo implode($row);
							...
							<div class="panel">
								...
								<div class="panel-body no-padding">
									<table class="table table-striped">
										...
										<tbody>
											<?php
												$stmt = $admin -> ret("SELECT * FROM `auditedfiles` ORDER BY `a_id` DESC LIMIT 10");
												$i=0;
								...
								<div class="panel-footer">
									<div class="row">
										...
										<div class="col-md-6 text-right"><a href="verifyaf.php" class="btn btn-primary">View All Audited Files</a></div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="panel">
												...
												<div class="modal-body">
													<form action="../../Controller/admin/add.php" method="POST">
														<div class="form-group">
															...
															<input type="text" name="tname" class="form-control" required="" id="">
														</div>
														<div class="form-group">
															<label for="" class="label-control">To Do Description : </label>
															<textarea type="text" name="tdesc" class="form-control" rows="5" required=" " id=""></textarea>
														</div>
														<div class="form-group">
								...
								<div class="panel-body">
									...
									<?php
												$stmt = $admin -> ret("SELECT * FROM `to_do_list` ORDER BY `t_id` DESC");
												$i=0;
												while($row = $stmt-> fetch(PDO::FETCH_ASSOC))
												{ 
													$i++;
										...
										<li>
											...
											<a href="../../Controller/admin/delete.php?dlttodo=<?= $row['t_id']?>"><img height="30px" src="./../../images/delete.png" alt=""></a>
										</li>
