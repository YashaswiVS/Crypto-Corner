	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="main-content">
                ...
                <a href="fromcmessges.php" class="btn btn-primary">Go Back</a>
                                                ...
                                                <div id="demo-chat-body" class="collapse in">
                                                        ...
                                                        <div class="nano-content pad-all" tabindex="0" style="right: -17px;">
                                                          ...
                                                          $abstmt = $admin -> ret("SELECT * FROM `admin` WHERE `id` = '1'");
                                                            $abrow = $abstmt -> fetch(PDO::FETCH_ASSOC);
                                                                ...
                                                                $stmt = $admin -> ret("SELECT * FROM `admin_msg_to_client` WHERE `c_id` = '$cid'");
                                                    ...
                                                    <div class="panel-footer">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-9">
                                                                <input type="hidden" required=" " name="cl" value="<?= $cid?>">
                                                                <input type="text" required=" " name="msg" placeholder="Enter your text" class="form-control chat-input">
                                                            </div>
                                                            <div class="col-xs-3">
                                                                <button class="btn btn-primary btn-block" type="submit" name="fromadmintoclient">Send</button>
                                                            </div>
