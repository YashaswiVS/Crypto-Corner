		...
		<div class="main">
			...
			<div class="main-content">
                ...
                <div class="panel container" style="padding:10px;">
                        ...
                        <input type="hidden" name="cid" value="<?php echo $clid; ?>" />
                        <input type="hidden" name="qid" value="<?php echo $getqID; ?>" />
                        <input type="submit" class="btn btn-primary" name="rep" value="Send">
                        ...
                        <tbody>
                            ...
                            <?php
                            $stmt = $admin -> ret("SELECT * FROM `replay`");
                            $i=0;
